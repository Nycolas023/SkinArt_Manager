...
AS
BEGIN
	SELECT USUARIO.*, PAPEL.NOME_PAPEL FROM USUARIO
	LEFT JOIN USUARIO_PAPEL
	ON USUARIO_PAPEL.ID_USUARIO = USUARIO.ID_USUARIO
	LEFT JOIN PAPEL
	ON PAPEL.ID_PAPEL = USUARIO_PAPEL.ID_PAPEL
	WHERE LOGIN_USUARIO = @LOGIN AND SENHA_USUARIO = @SENHA
	AND NOME_PAPEL = 'ADMIN'
END
