...
-- AJUSTE: Adicionando os campos COMISSAO, METODO_PAGAMENTO, OBSERVACOES
...
INSERT INTO USUARIO (
    ...
    'Maria', 'Tatuadora', '1985-08-22',
    '111.222.333-44', '12.324.543-9',
    'maria.silva', 'maria123',
    'ATIVO', GETDATE()
);
DECLARE @MariaTatuadoraId INT = SCOPE_IDENTITY();

INSERT INTO USUARIO_PAPEL (ID_USUARIO, ID_PAPEL)
VALUES (@MariaTatuadoraId, (SELECT ID_PAPEL FROM PAPEL WHERE NOME_PAPEL = 'Tatuador'));

INSERT INTO TATUADOR (ID_USUARIO, DESCRICAO_TATUADOR, CNAE_FORMACAO_TATUADOR)
VALUES (@MariaTatuadoraId, 'Especialista em realismo preto e cinza.', '9602501');
...
BEGIN
    INSERT INTO OrdemServico (
        ...
        COMISSAO, METODO_PAGAMENTO, OBSERVACOES
    )
    VALUES (
        @ID_CLIENTE, @ID_TATUADOR, @DESCRICAO_SERVICO, @VALOR, @STATUS_SERVICO,
        @COMISSAO, @METODO_PAGAMENTO, @OBSERVACOES
...
CREATE PROCEDURE stp_atualizar_ordem_servico
    ...
    @ID_CLIENTE INT, -- Adicionado
    @ID_TATUADOR INT, -- Adicionado
    @DESCRICAO_SERVICO VARCHAR(300),
    @VALOR DECIMAL(10,2),
    @STATUS_SERVICO VARCHAR(50),
    @COMISSAO DECIMAL(10,2) = NULL,
...
BEGIN
    SELECT 
        OS.ID_ORDEM_SERVICO,
        OS.ID_CLIENTE, -- Adicionado
        OS.ID_TATUADOR, -- Adicionado
